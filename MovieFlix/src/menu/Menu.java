...
public class Menu {
	...
	public static void MostrarMenu() {
		...
		System.out.println("  Opción 10: Dar de alta un usuario.");							// Pide al usuario el nombre completo, fecha de nacimiento y lugar de residencia del cliente y lo da de alta.
